...
public class DateFormatTester {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" 2. " + DateFormat.getDateInstance(DateFormat.SHORT, Locale.US).format(now));
        ...
        System.out.println("11. " + DateFormat.getDateInstance(DateFormat.DEFAULT, new Locale("en") ).format(new Date())  );
    }
}
